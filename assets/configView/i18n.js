...
(function () {
	...
	const I18N_ZH_CN = {
		...
		"Manual Setup": "手动设置",
		"Search Presets": "搜索预设",
		"Search model or provider": "搜索模型或提供商",
		"Provider": "提供商",
		"All providers": "所有提供商",
		"Category": "类别",
		"All categories": "所有类别",
		...
		"All statuses": "所有状态",
		"Configured": "已配置",
		"Provider Ready": "提供商就绪",
		"Key Needed": "需要密钥",
		"Provider Needed": "需要提供商",
		...
		"Base URL for the model provider.": "模型提供商的 Base URL。",
		...
		"LiteLLM extra_body parameters for provider/proxy-specific options.": "LiteLLM 的 extra_body 参数，用于提供商/代理特定选项。",
		"Prompt Cache (JSON)": "提示缓存 (JSON)",
		"Provider-aware prompt/KV cache configuration.": "提供商感知的提示/KV 缓存配置。",
		"Save Model": "保存模型",
		"Cancel": "取消",

		// Provider usage check
		"Provider Usage Check": "提供商用量检查",
		"Check All": "全部检查",
		"Usage Plan": "用量套餐",
		...
		"provider setup is missing for {0}": "缺少 {0} 的提供商配置",
		...
		"Cannot add selected model(s): {0}. Open OAIProxy Configuration > Provider Management and add the provider base URL/API mode/API key, or use the provider API key command, then try Add Selected again.":
			"无法添加所选模型：{0}。请打开 OAIProxy 配置 > 提供商管理，添加提供商的 Base URL/API 模式/API 密钥，或使用提供商 API 密钥命令，然后再试“添加所选”。",
		"Are you sure you want to delete model {0}?": "确定要删除模型 {0} 吗？",
		"Remove {0} selected configured model(s)?": "移除所选 {0} 个已配置的模型？",
		"Are you sure you want to delete provider {0} and all its models?": "确定要删除提供商 {0} 及其所有模型吗？",
		"provider only": "仅提供商",
		"+{0} more": "+{0} 个更多",
		"Unavailable": "不可用",
		"Not checked": "未检查",
		...
		"No configured providers have known usage-check behavior yet": "尚无具有已知用量检查行为的已配置提供商",
		...
		"Provider API Key is required for models with a provider Base URL.": "带有提供商 Base URL 的模型必须填写提供商 API 密钥。",
		...
		"Enter provider API key": "输入提供商 API 密钥",
